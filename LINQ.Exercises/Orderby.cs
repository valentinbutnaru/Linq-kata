...
namespace LINQ.Exercises
{
    ...
    public class OrderBy
    {
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderBy(n => n);
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderBy(n => n.ElementAt(1));
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderByDescending(n => n);
        ...
        {
            IEnumerable<string> result = TestData.OrderByWords.OrderBy(n => n.Length);
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderBy( n => n , new ComparerCondition());
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.OrderBy(n => n.Born.Date);
        ...
        public void OrderByLengthAndThenAlphabetically_returnStringNumberation()
        {
            ...
            IEnumerable<string> result = digits.OrderBy(n => n.Length).ThenBy(n => n);
        ...
        public void OrderByLengthThenAlphabeticallyIgnoringCase_returnStringEnumeration()
        {
            ...
            IEnumerable<string> result = words.OrderBy(n => n .Length).ThenBy(n => n);
