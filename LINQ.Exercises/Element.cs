...
namespace LINQ.Exercises
{
    ...
    public class Element
    {
        ...
        {
            int result = TestData.Numbers.First(n => n == 2);
        ...
        {
            int result = TestData.Numbers.Last(n => n == -4);
        ...
        {
            string result = TestData.Animals.First(n => n.Length == 4);
        ...
        {
            string result = TestData.Animals.Last(n => n.Contains("g"));
        ...
        {
            string result = TestData.Animals.First(n => n.ElementAt(0) == 's');
        ...
        {
            TestData.Person result = TestData.People.First(n => n.Born.Year > 2000);
        ...
        {
            TestData.Person result = TestData.People.Last(n => n.LastName.EndsWith("l"));
        ...
        {
            TestData.Person result = TestData.People.First(n => n.Born.DayOfYear == 141);
        ...
        {
            TestData.Person result = TestData.People.LastOrDefault(n => n.FirstName.ElementAt(0) != 'J');
