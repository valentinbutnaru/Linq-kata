...
namespace LINQ.Exercises
{
    ...
    public class Restriction
    {
        ...
        {
            IEnumerable<int> result = TestData.Numbers.Where(n => (n == 2) || (n == -4));
        ...
        {
            IEnumerable<int> result = TestData.Numbers.Where(n => (n < 0 ) && (n == -4));
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.ElementAt(1) == 'i') ;
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.ToUpper().EndsWith("T"));
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(s => s.FirstName.ElementAt(0) == s.LastName.ElementAt(0));
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(n => ( n.Born.Day == 12) || (n.Born.Day == 16));
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(n => n.Born.Day == 21) ;
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where( n =>  2000 - n.Born.Year > 18);
